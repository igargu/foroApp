        ...
        <div class="nav-wrapper position-relative end-0">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action ="{{ url('post') }}" method="post" role="form" class="text-start">
                  @csrf
                  <div class="input-group input-group-static mb-4">
                    <label>Título</label>
                    <input class="form-control" type="text" name="titulo" id="titulo" minlength="1" maxlength="100" value="{{ old('titulo') }}" required>
                    @error('titulo')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  <div class="input-group input-group-static mb-4">
                    <label>Mensaje</label>
                    <input class="form-control" type="text" name="mensaje" id="mensaje" minlength="1" maxlength="200" value="{{ old('mensaje') }}" required>
                    @error('mensaje')
                      <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
